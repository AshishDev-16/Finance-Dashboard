"""
Django settings for AdminDashbord project.
...
SECRET_KEY = 'django-insecure-hn$z)b__fb3j1_&^_+f6kt*n%_a7x!wk45%!1*io$vj1=^+avj'
...
WSGI_APPLICATION = 'AdminDashbord.wsgi.application'
